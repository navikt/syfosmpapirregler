...
graph TD
    ...
    root_PASIENT_YNGRE_ENN_13_UGYLDIG_REGELSETTVERSJON(UGYLDIG_REGELSETTVERSJON) -->|No| root_PASIENT_YNGRE_ENN_13_UGYLDIG_REGELSETTVERSJON_UGYLDIG_ORGNR_LENGDE(UGYLDIG_ORGNR_LENGDE)
    root_PASIENT_YNGRE_ENN_13_UGYLDIG_REGELSETTVERSJON_UGYLDIG_ORGNR_LENGDE(UGYLDIG_ORGNR_LENGDE) -->|Yes| root_PASIENT_YNGRE_ENN_13_UGYLDIG_REGELSETTVERSJON_UGYLDIG_ORGNR_LENGDE_INVALID(INVALID):::invalid
    root_PASIENT_YNGRE_ENN_13_UGYLDIG_REGELSETTVERSJON_UGYLDIG_ORGNR_LENGDE(UGYLDIG_ORGNR_LENGDE) -->|No| root_PASIENT_YNGRE_ENN_13_UGYLDIG_REGELSETTVERSJON_UGYLDIG_ORGNR_LENGDE_BEHANDLER_FNR_ER_SAMME_SOM_PASIENT_FNR(BEHANDLER_FNR_ER_SAMME_SOM_PASIENT_FNR)
    root_PASIENT_YNGRE_ENN_13_UGYLDIG_REGELSETTVERSJON_UGYLDIG_ORGNR_LENGDE_BEHANDLER_FNR_ER_SAMME_SOM_PASIENT_FNR(BEHANDLER_FNR_ER_SAMME_SOM_PASIENT_FNR) -->|Yes| root_PASIENT_YNGRE_ENN_13_UGYLDIG_REGELSETTVERSJON_UGYLDIG_ORGNR_LENGDE_BEHANDLER_FNR_ER_SAMME_SOM_PASIENT_FNR_INVALID(INVALID):::invalid
    root_PASIENT_YNGRE_ENN_13_UGYLDIG_REGELSETTVERSJON_UGYLDIG_ORGNR_LENGDE_BEHANDLER_FNR_ER_SAMME_SOM_PASIENT_FNR(BEHANDLER_FNR_ER_SAMME_SOM_PASIENT_FNR) -->|No| root_PASIENT_YNGRE_ENN_13_UGYLDIG_REGELSETTVERSJON_UGYLDIG_ORGNR_LENGDE_BEHANDLER_FNR_ER_SAMME_SOM_PASIENT_FNR_OK(OK):::ok
    classDef ok fill:#c3ff91,stroke:#004a00,color: black;
    classDef invalid fill:#ff7373,stroke:#ff0000,color: black;
    classDef manuell fill:#ffe24f,stroke:#ffd500,color: #473c00;
```
