...
graph TD
    ...
    root_TILBAKEDATERING_SPESIALISTHELSETJENESTEN(SPESIALISTHELSETJENESTEN) -->|Yes| root_TILBAKEDATERING_SPESIALISTHELSETJENESTEN_OK(OK):::ok
    ...
    root_TILBAKEDATERING_SPESIALISTHELSETJENESTEN_ETTERSENDING(ETTERSENDING) -->|Yes| root_TILBAKEDATERING_SPESIALISTHELSETJENESTEN_ETTERSENDING_OK(OK):::ok
    ...
    root_TILBAKEDATERING_SPESIALISTHELSETJENESTEN_ETTERSENDING_TILBAKEDATERT_INNTIL_4_DAGER(TILBAKEDATERT_INNTIL_4_DAGER) -->|Yes| root_TILBAKEDATERING_SPESIALISTHELSETJENESTEN_ETTERSENDING_TILBAKEDATERT_INNTIL_4_DAGER_OK(OK):::ok
