...
class LegeSuspensjonClientTest : Spek({
        ...
        routing {
            get("/api/v1/suspensjon/status") {
                when {
                    ...
                    call.request.headers["Nav-Personident"] == "behandlerFinnesIkke" -> call.respond(HttpStatusCode.NotFound, "Behandler finnes ikke")
    ...
    describe("Test LegeSuspensjonClientTest") {
        ...
        it("Should get suspensjon == false") {
            runBlocking {
                val suspensjon = legeSuspensjonClient.checkTherapist("2", "2", "2019-01-01")
