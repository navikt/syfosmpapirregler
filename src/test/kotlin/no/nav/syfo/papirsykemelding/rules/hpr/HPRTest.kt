    ...
    FunSpec(
        {
            ...
            context("Testing hpr rules and checking the rule outcomes") {
                ...
                test(
                    "mangler autorisasjon, Status _root_ide_package_.no.nav.syfo.model.Status.MANUAL_PROCESSING"
                ) {
                    val sykmelding =
                        generateSykmelding(
                            fom = LocalDate.of(2020, 1, 1),
                ...
                test(
                    "Manuellterapaut har aktiv autorisasjon, sykefravæt over 12 uker, Status _root_ide_package_.no.nav.syfo.model.Status.MANUAL_PROCESSING"
                ) {
                    val sykmelding =
                        generateSykmelding(
                            fom = LocalDate.of(2020, 1, 1),
                ...
                test(
                    "behandler ikke riktig helsepersonell kategori, Status _root_ide_package_.no.nav.syfo.model.Status.MANUAL_PROCESSING"
                ) {
                    val sykmelding =
                        generateSykmelding(
                            fom = LocalDate.of(2020, 1, 1),
                ...
                test(
                    "FT uten tilleggsinfo, Status _root_ide_package_.no.nav.syfo.model.Status.MANUAL_PROCESSING"
                ) {
                    val sykmelding =
                        generateSykmelding(
                            fom = LocalDate.of(2020, 1, 1),
                ...
                test(
                    "FT Gyldig over 12 uker, _root_ide_package_.no.nav.syfo.model.Status.MANUAL_PROCESSING"
                ) {
                    val behandler =
                        generateBehandler(
                            "FT",
                ...
                test(
                    "KI uten tilleggsinfo, Status _root_ide_package_.no.nav.syfo.model.Status.MANUAL_PROCESSING"
                ) {
                    val sykmelding =
                        generateSykmelding(
                            fom = LocalDate.of(2020, 1, 1),
                ...
                test(
                    "KI Gyldig over 12 uker, _root_ide_package_.no.nav.syfo.model.Status.MANUAL_PROCESSING"
                ) {
                    val behandler =
                        generateBehandler(
                            "KI",
