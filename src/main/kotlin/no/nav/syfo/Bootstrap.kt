...
fun main() {
    ...
    val syketilfelleClient =
        ClientFactory.createSyketilfelleClient(env, accessTokenClientV2, httpClient)
    val legeSuspensjonClient =
        ClientFactory.createLegeSuspensjonClient(env, accessTokenClientV2, httpClient)
    val norskHelsenettClient =
        ClientFactory.createNorskHelsenettClient(env, accessTokenClientV2, httpClient)
