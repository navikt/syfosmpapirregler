...
internal fun RuleNode<PatientAgeUnder13Rules, RuleResult>.yes(
    ...
    yes(RuleResult(status, JuridiskEnum.FOLKETRYGDLOVEN_8_3_1.JuridiskHenvisning, ruleHit?.ruleHit))
}
...
internal fun RuleNode<PatientAgeUnder13Rules, RuleResult>.no(
    ...
    no(RuleResult(status, JuridiskEnum.FOLKETRYGDLOVEN_8_3_1.JuridiskHenvisning, ruleHit?.ruleHit))
}
